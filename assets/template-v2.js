(function () {
  ...
  shell.outerHTML = [
    ...
    '<main class="product-page">',
      ...
      '<section class="order-steps" aria-label="How to order"><div><b>1</b><span><strong>Choose options</strong><small>Select several colors and set a quantity for each.</small></span></div><div><b>2</b><span><strong>Add delivery details</strong><small>Choose the delivery area, then enter your details.</small></span></div><div><b>3</b><span><strong>Send on WhatsApp</strong><small>Review the total and send through either account.</small></span></div></section>',
    '</main>',
  ...
  site.src = '../../assets/site.js?v=20260818-1';
